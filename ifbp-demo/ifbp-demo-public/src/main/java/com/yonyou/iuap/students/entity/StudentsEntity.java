package com.yonyou.iuap.students.entity;
 ...
 * @version 
 */
@Entity(namespace = "TrainMgt-public",name = "StudentsEntity")
@Table(name = "Train_Students")
